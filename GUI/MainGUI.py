...
"}"))
        ...
        self.formLayout_2.setWidget(3, QtGui.QFormLayout.FieldRole, self.toggle_led0)

        self.useHeater_0 = QtGui.QCheckBox(self.cont_voltage)
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("KacstTitleL"))
        font.setPointSize(12)
        self.useHeater_0.setFont(font)
        self.useHeater_0.setStyleSheet(_fromUtf8("margin-top: 10px;"))
        self.useHeater_0.setObjectName(_fromUtf8("useHeater_0"))
        self.useHeater_0.toggled.connect(lambda: self.Heater(0))

        self.formLayout_2.setWidget(4, QtGui.QFormLayout.FieldRole, self.useHeater_0)
...
"background-color: #4988af;"))
        ...
        self.formLayout_8.setWidget(4, QtGui.QFormLayout.LabelRole, self.toggle_led1)

        self.useHeater_1 = QtGui.QCheckBox(self.sine_voltage)
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("KacstTitleL"))
        font.setPointSize(12)
        self.useHeater_1.setFont(font)
        self.useHeater_1.setStyleSheet(_fromUtf8("margin-top: 10px;"))
        self.useHeater_1.setObjectName(_fromUtf8("useHeater_1"))
        self.useHeater_1.toggled.connect(lambda: self.Heater(1))

        
        self.formLayout_8.setWidget(4, QtGui.QFormLayout.FieldRole, self.useHeater_1)
...
"background-color: #4988af;"))
        ...
        self.useHeater_2 = QtGui.QCheckBox(self.variable_voltage)
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("KacstTitleL"))
        font.setPointSize(12)
        self.useHeater_2.setFont(font)
        self.useHeater_2.setStyleSheet(_fromUtf8("margin-top: 10px;"))
        self.useHeater_2.setObjectName(_fromUtf8("useHeater_2"))
        self.useHeater_2.toggled.connect(lambda: self.Heater(2))

        self.formLayout_3.setWidget(4, QtGui.QFormLayout.FieldRole, self.useHeater_2)
        ...
        self.formLayout_3.setWidget(5, QtGui.QFormLayout.FieldRole, self.addopt2)
...
"<span style=\" font-size:12pt; color:#4988af;text-decoration: none;\">Already a user? Sign in!</span></a></p></body></html>", None))
        ...
        self.useHeater_0.setText(_translate("MainWindow", "Use Heater", None))
        ...
        self.useHeater_1.setText(_translate("MainWindow", "Use Heater", None))
        ...
        self.useHeater_2.setText(_translate("MainWindow", "Use Heater", None))
    ...
    def Heater(self,c):
        ...
        if c == 0:
            if self.useHeater_0.isChecked() == True:
                self.win = QtGui.QMainWindow()
                self.ui = PID.Ui_MainWindow()
                self.ui.setupUi(self.win)
                self.win.show()
                
        elif c == 1:
            if self.useHeater_1.isChecked() == True:
                self.win = QtGui.QMainWindow()
                self.ui = PID.Ui_MainWindow()
                self.ui.setupUi(self.win)
                self.win.show()
            ...
            if self.useHeater_2.isChecked() == True:
                self.win = QtGui.QMainWindow()
                self.ui = PID.Ui_MainWindow()
                self.ui.setupUi(self.win)
                self.win.show()
